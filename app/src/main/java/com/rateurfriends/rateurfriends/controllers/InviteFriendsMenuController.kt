...
import com.rateurfriends.rateurfriends.InviteFriendsMenuActivity
...
class InviteFriendsMenuController(
        var activity: InviteFriendsMenuActivity
) {
    ...
    private fun getContacts(map: LinkedHashMap<String, Contact>,
        ...
        UserDAO.getInvitedContactsForUser(Globals.getInstance().user!!.userId) {
            ...
            val runner = InviteFriendsController.AsyncTaskRunner(contentResolver, invitedPhoneSet, map, adapter)
            runner.execute()
        }
